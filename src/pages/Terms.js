    ...
    <div id="terms" className="container">
      <div className="row justify-content-center">
        <div className="col-12">
          <SectionTitle titanium animate title="Ownership"></SectionTitle>
          <p>
            A). You Own the After Party Ape Club NFT. Each After Party Ape is an
            NFT on the Ethereum blockchain. When you purchase an NFT, you own the
            underlying After Party Ape Club, the Art, completely. Ownership of the
            NFT is mediated entirely by the Smart Contract and the Ethereum
            Network. At no time may we seize, freeze, or otherwise modify the
            ownership of any After Party Ape Club NFT. <br />
            B). Personal Use. Subject to continued compliance with these Terms,
            you maintain a royalty-free license to use, copy, and display the
            purchased Art, along with any extensions that you choose to create or
            use, solely for the following purposes: (i) for your own personal,
            non-commercial use; (ii) as part of a marketplace that permits the
            purchase and sale of your After Party Ape Club / NFT, provided that
            the marketplace cryptographically verifies each After Party Ape Club
            owner’s rights to display the Art for their After Party Ape Club NFT
            to ensure that only the actual owner can display the Art; or (iii) as
            part of a third party website or application that permits the
            inclusion, involvement, or participation of your After Party Ape Club,
            provided that the website/application cryptographically verifies each
            After Party Ape Club owner’s rights to display the Art for their After
            Party Ape Club NFT to ensure that only the actual owner can display
            the Art, and provided that the Art is no longer visible once the owner
            of the After Party Ape Club NFT leaves the website/application.
            <br />
            C). Commercial Use. Subject to continued compliance with these Terms,
            you maintain an unlimited, worldwide license to use, copy, and display
            the purchased Art for the purpose of creating derivative works based
            upon the Art (“Commercial Use”). Examples of such Commercial Use would
            e.g. be the use of the Art to produce and sell merchandise products
            (T-Shirts etc.) displaying copies of the Art. For the sake of clarity,
            nothing in this Section will be deemed to restrict you from (i) owning
            or operating a marketplace that permits the use and sale of After
            Party Apes Club NFT generally, provided that the marketplace verifies
            each After Party Ape Club owner’s rights to display the Art for their
            After Party Ape Club NFT to ensure that only the actual owner can
            display the Art; (ii) owning or operating a third party website or
            application that permits the inclusion, involvement, or participation
            of After Party Apes, provided that the third party website or
            application verifies each After Party Ape Club owner’s rights to
            display the Art for their After Party Ape Club NFT to ensure that only
            the actual owner can display the Art, and provided that the Art is no
            longer visible once the owner of the Purchased After Party Ape Club
            NFT leaves the website/application; or (iii) earning revenue from any
            of the foregoing.
          </p>
        </div>
        <div className="col-12">
          <SectionTitle titanium animate title="Your Obligations"></SectionTitle>
          <p>
        ...
        <div className="12">
          <SectionTitle titanium animate title="Fees and Payment"></SectionTitle>
          <p>
            A). If you elect to purchase an After Party Ape Club NFT through the
            ...
            that you conduct via the Ethereum network. <br />
        ...
        <div className="12">
          <SectionTitle titanium animate title="Disclaimers"></SectionTitle>
          <p>
            ...
            NOT APPLY TO YOU. <br />B). YOU ACCEPT THE INHERENT SECURITY RISKS OF
            ...
            UNLESS IT IS DUE TO OUR WILLFUL MISCONDUCT. <br />
        ...
        <div className="col-12">
          <SectionTitle titanium animate title="Risk Assumption"></SectionTitle>
          <p>
            You accept and acknowledge each of the following: <br />
            A). To the extent that you sell your After Party Ape Club NFT, please
            be aware that the prices of NFTs are extremely volatile and
            fluctuations in the prices of other NFTs and impact the price of your
            After Party Ape Club NFT both positively and negatively. Given the
            volatility, NFTs such as After Party Apes should not be considered an
            investment. You assume all risks in that connection. <br />
            B). Ownership of an After Party Ape Club NFT confers ownership of
            ...
            purpose. Further, nothing on this Site qualifies or is intended to be
            an offering of securities in any jurisdiction nor does it constitute
            an offer or an invitation to purchase shares, securities or other
            financial products. Due to the artistic nature of the project, After
            Party Ape Club has not been registered with or approved by any
            regulator in any jurisdiction. It remains your sole responsibility to
            ensure that the purchase of the After Party Ape Club and the
            ...
            access to information stored within your wallet.<br />
            ...
            negatively impact such technologies impacting the value for your After
            Party Ape Club NFT. You understand and accept all risk in that
            regard.<br />
        ...
        <div className="col-12">
          <SectionTitle titanium animate title="Indemnification"></SectionTitle>
          <p>
            You agree to hold harmless and indemnify After Party Ape Club and its
        ...
        <div className="col-12">
          ...
          ></SectionTitle>
          <p>
            We reserve the right to make changes to the Terms at our discretion.
            Please check these Terms periodically for changes. Any changes to the
            Terms will apply on the date that they are made, and your continued
        ...
        <div className="col-12">
          <SectionTitle titanium animate title="Children"></SectionTitle>
          <p>
            Our Site is not intended for children. You must be at least 18 years
            old to access this Site or purchase an After Party Ape. If you are
        ...
        <div className="col-12">
          ...
          <p>
            ...
            finally resolved by arbitration. Each party will cover its own fees
            and costs associated with the arbitration proceedings. The place of
            arbitration will be Toronto, Ontario. The award of the arbitrator will
            ...
            relief in any jurisdiction in any court of competent jurisdiction.<br />
